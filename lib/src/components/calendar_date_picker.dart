          ...
          child: onSelectYear
              ? MonthNameWidget(
                  ...
                  onMonthSelected: (month) {
                    widget.onChanged(DateTime(yearSelected, month));
                  },
                )
              : GridView.builder(
...
class MonthNameWidget extends StatefulWidget {
  ...
  @override
  State<MonthNameWidget> createState() => _MonthNameWidgetState();
}

class _MonthNameWidgetState extends State<MonthNameWidget> {
  String getLocalizedMonthName(int month) {
    final locale = Localizations.localeOf(context);
    final DateTime date = DateTime(widget.yearSelected, month);
    final DateFormat formatter = DateFormat.MMMM(locale.toString());
    return formatter.format(date);
  }

  bool get isDisabled =>
      widget.yearSelected < widget.firstDate.year ||
      widget.yearSelected > widget.lastDate.year;
        ...
        Expanded(
          child: GridView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              ...
              bool isDisabled = currentMonth < widget.firstDate.month ||
                  currentMonth > widget.lastDate.month;
              ...
              return InkWell(
                ...
                child: Center(
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: index + 1 == widget.initialMonth
                          ? Theme.of(context).colorScheme.primary
                          : null,
                      borderRadius: BorderRadius.circular(36),
                    ),
                    child: Text(
                      getLocalizedMonthName(index + 1),
                      style: Theme.of(context).textTheme.bodyLarge?.apply(
                            color: isDisabled
                                ? Theme.of(context).colorScheme.outline
                                : index + 1 == widget.initialMonth
